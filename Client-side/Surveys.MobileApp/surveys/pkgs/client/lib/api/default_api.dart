...
class DefaultApi {
    ...
    DefaultApi(this._dio, this._serializers);
        ...
        Future<Response<List<OpenapiVoteAmount>>>getActualVotes({ int seid,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/service/getActualVotes";
        ...
        List<String> contentTypes = [];
            ...
            cancelToken: cancelToken,
                ...
                final FullType type = const FullType(BuiltList, const [const FullType(OpenapiVoteAmount)]);
                BuiltList<OpenapiVoteAmount> dataList = _serializers.deserialize(response.data is String ? jsonDecode(response.data) : response.data, specifiedType: type);
                var data = dataList.toList();

            return Response<List<OpenapiVoteAmount>>(
                data: data,
                headers: response.headers,
                request: response.request,
                redirects: response.redirects,
